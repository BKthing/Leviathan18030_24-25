...
public class MeepMeepTesting {
    public static void main(String[] args) {
        MeepMeep meepMeepTesting = new MeepMeep(800);
...
//                    intake.toIntakeState(NewIntake.ToIntakeState.DROP_INTAKE);
        ...
        RoadRunnerBotEntity secondBot = new DefaultBotBuilder(meepMeepTesting)
                .setConstraints(60, 60, Math.toRadians(180), Math.toRadians(180), 15)
...
//                            outtake.toOuttakeState(NewOuttake.ToOuttakeState.TOUCH_BAR);
        ...
        meepMeepTesting.setBackground(MeepMeep.Background.FIELD_INTO_THE_DEEP_JUICE_DARK)
                .setDarkMode(true)
