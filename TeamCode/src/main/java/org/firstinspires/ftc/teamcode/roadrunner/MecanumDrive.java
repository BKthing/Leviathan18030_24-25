...
public final class MecanumDrive {
    ...
    public static class Params {
        ...
        public double kS = 1.579568863855739;
        public double kV = 0.0003889546799981593;
...
//    public final CluelessConstAccelLocalizer localizer;
...
//    }
    ...
    public MecanumDrive(HardwareMap hardwareMap,  com.reefsharklibrary.data.Pose2d pose) {
...
//        voltageSensor = hardwareMap.voltageSensor.iterator().next();
    ...
    public void updatePoseEstimate(com.reefsharklibrary.data.Pose2d pose, com.reefsharklibrary.data.Pose2d poseVelocity) {
        this.pose = new Pose2d(pose.getX(), pose.getY(), pose.getHeading());

        poseHistory.add(this.pose);
        while (poseHistory.size() > 100) {
            poseHistory.removeFirst();
        }

        estimatedPoseWriter.write(new PoseMessage(this.pose));

        this.poseVelocity = new PoseVelocity2d(new Vector2d(poseVelocity.getX(), poseVelocity.getY()), poseVelocity.getHeading());
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            PoseVelocity2d robotVelRobot = updatePoseEstimate();//poseVelocity

            PoseVelocity2dDual<Time> command = new HolonomicController(
                    PARAMS.axialGain, PARAMS.lateralGain, PARAMS.headingGain,
                    PARAMS.axialVelGain, PARAMS.lateralVelGain, PARAMS.headingVelGain
            )
                    .compute(txWorldTarget, pose, robotVelRobot);//.compute(txWorldTarget, new Pose2d(80, 20, Math.toRadians(0)), new PoseVelocity2d(new Vector2d(0, 0), 0));//
...
//            rightFront.setPower(feedforward.compute(wheelVels.rightFront) / voltage);
    ...
    public TrajectoryActionBuilder actionBuilder(com.reefsharklibrary.data.Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                ...
                new Pose2d(new Vector2d(beginPose.getX(), beginPose.getY()), beginPose.getHeading()), 0.0,
