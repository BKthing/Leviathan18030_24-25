...
@Config
public final class ModifiedTwoDeadWheelLocalizer{//} implements Localizer {
//    public static class Params {
//        public double parYTicks = 1042.97; // y position of the parallel encoder (in tick units)
//        public double perpXTicks = -1608.48; // x position of the perpendicular encoder (in tick units)
//    }
//
...
//
//    private final double inPerTick = .94*2*Math.PI/2000;
//
//    private double lastRawHeadingVel, headingVelOffset;
//    private boolean initialized;
//
//    public ModifiedTwoDeadWheelLocalizer() {
