...
public class RobotConstants {
    public static PIDCoeficients lateralPID = new PIDCoeficients(.16, .0, .022, 0, 0, 0);//.18 .014
    ...
    public static PIDCoeficients headingPointPID = new PIDCoeficients(.06, 0, 0.0018);//.002
